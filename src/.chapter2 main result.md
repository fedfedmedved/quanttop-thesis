...
<!----
EQUAL AREA! we don't seem to actually need equal length anywhere, except maybe simlicial approximation.
----> 
...
<!----
I should have done the orientation part in a clean way, but whatever. The clean way would have been with definitions, examples and sketches.
---->
...
<!---
BAD NOTATION in the proof above! psi and whatnot - I need to figure out names for those constants and put them in a diagram.  
---->
