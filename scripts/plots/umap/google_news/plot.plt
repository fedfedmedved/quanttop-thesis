...
set style line 6 lc rgb '#ad3f9a' pt 9 ps 1.5 lt 1 lw 5 # --- 
...
#set ytics 20
dataset = "../../../data/umap/google_news/google_news.dat"
...
plot dataset u 1:3 notitle smooth csplines ls 1,\
     ...
     dataset u 1:8 notitle smooth csplines ls 6,\
     ...
     dataset u 1:8 notitle with points ls 6,\
     ...
     6 / 0 title "spectral\\\_layout" with linespoints ls 6
